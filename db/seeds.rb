...
u114 = User.create(email: "abc24@gmail.com", password: "abcd", name: "abc24", role: User.roles["user"])
u115 = User.create(email: "abc25@gmail.com", password: "abcd", name: "abc25", role: User.roles["user"])
u116 = User.create(email: "abc26@gmail.com", password: "abcd", name: "abc26", role: User.roles["user"])

u1 = User.create(email: "abc27@gmail.com", password: "abcd", name: "abc27", role: User.roles["scheme_provider"])
u2 = User.create(email: "abc28@gmail.com", password: "abcd", name: "abc28", role: User.roles["scheme_provider"])


s = Schemes.create(name: 'standup india', guidelines: 'kindly submit proper proofs',  ticket_size: 200000, interest_rate: 3, department_id: d11.id, user_id: u11.id)
s1 = Schemes.create(name: 'Pradhan mantri mudra yojna', guidelines: 'kindly submit proper proofs', ticket_size: 500000, interest_rate: '5%', department_id: d11.id, user_id: u11.id)
s2 = Schemes.create(name: 'SIDBI', guidelines: 'kindly submit proper proofs',  ticket_size: 200000, interest_rate: 7.84, department_id: d12.id, user_id: u12.id)
s3 = Schemes.create(name: 'Startup Assistance Scheme', guidelines: 'kindly submit proper proofs',  ticket_size: 800000, interest_rate: 7.5, department_id: d12.id, user_id: u12.id)
s4 = Schemes.create(name: 'Union Nari Shakti', guidelines: 'kindly submit proper proofs',  ticket_size: 200000, interest_rate: 5, department_id: d13.id, user_id: u13.id)

e1= eligibilities.create(details: '',scheme_id: s,bucket: 0, value: 14, weight: (Random.rand()*100).to_i)
e2= eligibilities.create(details: '',scheme_id: s1,bucket: 1, value: 14, weight: (Random.rand()*100).to_i)
e3= eligibilities.create(details: '',scheme_id: s2,bucket: 2, value: 14, weight: (Random.rand()*100).to_i)
